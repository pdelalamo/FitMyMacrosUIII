...
const RecipeFeature: React.FC<Props> = ({ navigation }) => {
    return (
        <I18nextProvider i18n={i18n}>
            <View style={globalStyles.container}>
                <ImageBackground source={require('../../assets/images/main_background.png')} resizeMode="cover" style={globalStyles.imageBackground}>
                    <Image source={require('../../assets/images/recipeFeature.png')} style={productFeaturesStyles.middleImageFeatures} />
                    <View style={productFeaturesStyles.contentContainerFeatures}>
                        <View style={productFeaturesStyles.containerFeaturesText}>
                            <Text style={productFeaturesStyles.featureText}>{t('recipeFeature')}</Text>
                        </View>
                        <View style={globalStyles.buttonContainerFeatures}>
                            <TouchableOpacity style={globalStyles.buttonGreen} onPress={() => navigation.navigate('GoalsFeature')}>
